function shade_errorbar(varargin)
...
%     Y: m x n matrix of distribution of range values (the y-axis), where m 
...
[X,Yavg,Ystd,color_value,alpha_value,line_width] = parseinputs(varargin{:});
...
function [X,Yavg,Ystd,color_value,alpha_value,line_width] = parseinputs(varargin)
...
Yavg = varargin{2};
validateattributes(Yavg,{'numeric'},{'vector','nonnan','finite'},mfilename,'Yavg',2);
Ystd = varargin{3};
validateattributes(Ystd,{'numeric'},{'vector','nonnan','finite'},mfilename,'Ystd',2);
